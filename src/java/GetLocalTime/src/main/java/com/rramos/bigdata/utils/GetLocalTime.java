...
class GetLocalTime extends GenericUDF {
  ...
  public String getDisplayString(String[] arg0) {
    return "GetLocalTime()"; // Function description
  }
  ...
  public ObjectInspector initialize(ObjectInspector[] arguments) throws UDFArgumentException {
    ...
    if (arguments.length != 2) {
      throw new UDFArgumentLengthException("GetLocalTime only takes 2 arguments: String, String");
    }
  ...
  public Object evaluate(DeferredObject[] arguments) throws HiveException {
    ...
    try{
        ...
        DateTime thisDate = dtf1.parseDateTime(indate).withZone(zone);
        //Date  localDate = thisDate.toLocalDateTime().toDate();

        return dtf1.print(thisDate);
           
    }catch(Exception e){
      // In case of some exception caught return the same date
      //return ("Exception: "  + e );
      return indate;
    }
